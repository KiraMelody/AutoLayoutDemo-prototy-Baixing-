...
SWIFT_CLASS("_TtC14TestAutoLayout11AppDelegate")
...
@property (nonatomic, copy) NSArray<NSString *> * __nonnull titlename;
@property (nonatomic, copy) NSArray<NSString *> * __nonnull price;
